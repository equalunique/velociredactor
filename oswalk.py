...
parser.add_argument('--idir', help='Input directory containing PDFs and \/ or other directories', required=True)
parser.add_argument('--odir', help='Output directory to mirror the input directory', required=True)
parser.add_argument('--tmpl', help='GIMP XCF file as template for redaction', required=True)
args = parser.parse_args()

idir = os.path.abspath(args.idir)
odir = os.path.abspath(args.odir)
tmpl = os.path.abspath(args.tmpl)
